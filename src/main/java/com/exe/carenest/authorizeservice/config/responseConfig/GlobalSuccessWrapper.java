...
public class GlobalSuccessWrapper implements ResponseBodyAdvice<Object> {
    ...
    private final ObjectMapper objectMapper; // inject qua constructor nếu dùng @RequiredArgsConstructor
...
//            && !returnType.getParameterType().equals(ResponseEntity.class);
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        if (body instanceof String) {
            BaseResponse<Object> wrapped = BaseResponse.success(body,
                    "Success",
                    200,
                    metaBuilder.fromRequest(request),
                    UUID.randomUUID().toString(),
                    VERSION); // truyền meta, version...
            try {
